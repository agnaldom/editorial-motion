...
export const errorCodes = [
  ...
  'MOTION_PLAN_FAILED',
  'MOTION_PLAN_INVALID',
  'MOTION_PLAN_TOO_STATIC',
  'NO_LAYERABLE_ELEMENTS',
  'MOTION_STRATEGY_UNAVAILABLE',
  'RENDER_FAILED',
  'OUTPUT_VALIDATION_FAILED',
  'STATIC_RENDER_DETECTED',
  'QUALITY_GATE_FAILED',
  'TIMEOUT',
  'INTERNAL_ERROR',
] as const;
...
export const httpStatusFor: Record<ErrorCode, number> = {
  ...
  MOTION_PLAN_TOO_STATIC: 422,
  NO_LAYERABLE_ELEMENTS: 422,
  MOTION_STRATEGY_UNAVAILABLE: 422,
  RENDER_FAILED: 502,
  OUTPUT_VALIDATION_FAILED: 500,
  STATIC_RENDER_DETECTED: 422,
